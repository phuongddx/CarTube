...
- [ ] **Phase 2: Severance, Signing & Modernization** - Strip TrollStore/private-API surface, standard signing, iOS 16 target, scan gate
...
|-------|----------------|--------|-----------|
| 1. External Dependencies & Project Setup | 2/3 | In Progress|  |
