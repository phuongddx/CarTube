...
fixed_count: 3
total_count: 6
last_updated: 2026-08-19T14:39:36.714Z
---
...
| 6 | quick-260819-tkz | unrun-verify | fastlane/Fastfile |  | upload_beta full path (match -> gym -> scan -> pilot) unexecuted by design: needs APP_STORE_CONNECT_API_KEY_ID/ISSUER_ID + MATCH_GIT_URL/MATCH_PASSWORD + CarPlay capability enabled on App ID; guard branch is the verified behavior | open |  | 2026-08-19T14:39:36.714Z |  |
...
[
  ...
  },
  {
    "id": 6,
    "kind": "unrun-verify",
    "phase": "quick-260819-tkz",
    "file": "fastlane/Fastfile",
    "line": null,
    "description": "upload_beta full path (match -> gym -> scan -> pilot) unexecuted by design: needs APP_STORE_CONNECT_API_KEY_ID/ISSUER_ID + MATCH_GIT_URL/MATCH_PASSWORD + CarPlay capability enabled on App ID; guard branch is the verified behavior",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-08-19T14:39:36.714Z",
    "resolved_at": null
  }
]
````
